...
const UserCard = ({ userHist,setClickBadge,setShowmodel}) => {
...
<div className="absolute top-2 w-full">
      ...
      <div className="mt-4 flex justify-around py-3">
        <div className="bg-[#7B68EE] w-[75px] py-3 rounded-lg text-white text-center">
          <p className="font-semibold text-xl">{userHist?.points}</p>
          <p className="text-[10px] mt-1">Points</p>
        </div>
        <div className="bg-[#7B68EE] w-[75px] py-3 rounded-lg text-white text-center">
          <p className="font-semibold text-xl">#{userHist?.rank}</p>
          <p className="text-[10px] mt-1">Rank</p>
        </div>
        <div className="bg-[#7B68EE] w-[75px] py-3 rounded-lg text-white text-center">
          <p className="font-semibold text-xl">{userHist.level}</p>
      ...
      <div   className="  mt-4 h-[full]">
        ...
        <div  className="mt-4 w-full ">
          ...
          {active === "Badges" && <Badges userHist={userHist} setClickBadge={setClickBadge} setShowmodel={setShowmodel} />}
          {active === "Point History" && <Points userHist={userHist} />}
        </div>
      </div>
      </div>
